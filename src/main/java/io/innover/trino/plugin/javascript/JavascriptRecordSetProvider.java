...
public class JavascriptRecordSetProvider
        implements ConnectorRecordSetProvider
{
    ...
    @Inject
    public JavascriptRecordSetProvider(JavascriptConfig config, JavascriptMetadata metadata)
    {
        this.config = config;
            ...
            List<? extends ColumnHandle> list)
    {
        ...
        List<JavascriptColumnHandle> restColumnHandles = list
                .stream()
                .map(c -> (JavascriptColumnHandle) c)
                .collect(toList());
        ...
        List<Type> mappedTypes = restColumnHandles
                .stream()
                .map(JavascriptColumnHandle::getType)
                .collect(toList());
