...
public class JavascriptMetadata
        implements ConnectorMetadata
{
    ...
    public ConnectorTableHandle getTableHandle(ConnectorSession connectorSession, SchemaTableName schemaTableName)
    {
        ...
        return new JavascriptTableHandle(schemaTableName);
    }
    ...
    {
        JavascriptTableHandle tableHandle = Types.checkType(connectorTableHandle, JavascriptTableHandle.class, "tableHandle");
            ...
            ConnectorTableHandle connectorTableHandle)
    {
        return getTableMetadata(connectorSession, connectorTableHandle).getColumns().stream()
                .collect(toMap(ColumnMetadata::getName, column -> new JavascriptColumnHandle(column.getName(), column.getType())));
    }
    ...
    {
        JavascriptColumnHandle restColumnHandle = Types.checkType(columnHandle, JavascriptColumnHandle.class, "columnHandle");
    ...
    {
        JavascriptTableHandle tableHandle = Types.checkType(connectorTableHandle, JavascriptTableHandle.class, "tableHandle");
        return new JavascriptInsertTableHandle(tableHandle);
    }
